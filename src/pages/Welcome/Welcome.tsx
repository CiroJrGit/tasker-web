      ...
      <div className="flex flex-col gap-3 px-4">
        <Dialog.Root>
          ...
          >
            ...
            <span className="font-medium duration-10">Lista de tarefas</span>
          </Dialog.Trigger>

          <ModalWrap title="Nova página de lista">Teste modal</ModalWrap>
        </Dialog.Root>
        ...
        <Dialog.Root>
          ...
          >
            ...
            <span className="font-medium duration-10">Página de anotações</span>
          </Dialog.Trigger>

          <ModalWrap title="Nova página de anotações">Teste modal</ModalWrap>
        </Dialog.Root>
      </div>
    </div>
  );
