  ...
  return (
    <Dialog.Portal>
      <motion.div variants={shadow} initial="from" animate="to">
        ...
        <Dialog.Content className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 px-6 py-5 rounded-lg dark:bg-gray-900 bg-white-900 focus:outline-none">
