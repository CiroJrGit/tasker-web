    ...
    <>
      <div className="flex flex-col gap-6 px-5">
        <div className="flex flex-col gap-3">
          <span className="text-sm font-medium font-int dark:text-gray-100 text-gray-300">Meu perfil</span>
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div className="flex flex-col gap-3 w-[330px]">
            <span className="text-sm font-medium font-int leading-3 dark:text-gray-100 text-gray-300">Nome</span>
            <input
              className="
      ...
      <div className="flex flex-col gap-7 px-5">
        <div className="flex flex-col gap-3">
          <span className="text-sm font-medium font-int dark:text-gray-100 text-gray-300">Segurança</span>
        ...
        <div className="flex flex-col gap-10">
          <div className="flex justify-between items-center gap-3.5">
            <div className="flex flex-col gap-3 w-[352px]">
              <span className="text-sm font-normal font-int leading-3 dark:text-gray-100 text-gray-300">Email</span>
          ...
          <div className="flex justify-between items-center gap-3.5">
            <div className="flex flex-col gap-3 w-[352px]">
              <span className="text-sm font-normal font-int leading-3 dark:text-gray-100 text-gray-300">Senha</span>
              <span className="text-2xs font-normal font-int leading-3 dark:text-gray-200 text-white-300">
